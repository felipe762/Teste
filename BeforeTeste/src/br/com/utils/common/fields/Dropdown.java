...
public class Dropdown extends Field {
	...
	//Essa é a alteração do Erickson
...
//	}
	...
	private void clickOnDropdownOption(WebElement usedDropdown) {
		...
		String reference = usedDropdown.getAttribute("ui-autocomplete-reference");


		WebDriverWait wait  = new WebDriverWait(Page.driver, Page.timeOutInSeconds);
		wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath("ul[@ui-autocomplete-reference="+reference+"]")));
